...
const Projects = () => {
  return (
    <div 
      id="projects"
      className="w-full md:pl-20 p-4 py-16 mb-10 bg-gradient-to-br from-gradient-start via-gradient-middle to-gradient-end animate-gradient" // Tailwind animation and gradient classes
      style={{
        backgroundImage: `url(${backgroundImg})`, 
        backgroundSize: 'cover', 
        backgroundPosition: 'center',
