...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="flex items-center mt-1 justify-center min-h-screen relative overflow-hidden top-0 left-0 bg-white/100"
      style={{
        backgroundImage: 'url(/src/abt.jpg)', // Background image
        backgroundSize: 'cover',
        backgroundPosition: 'center',
    ...
    >
      ...
      {/* White Dots Animated Background */}
      <div className="absolute inset-0 bg-transparent z-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-1.5 h-1.5 bg-white rounded-full animate-moveDots"></div>
        <div className="absolute top-1/2 left-1/3 w-1.5 h-1.5 bg-white rounded-full animate-moveDots delay-200"></div>
        <div className="absolute top-2/3 left-1/4 w-1.5 h-1.5 bg-white rounded-full animate-moveDots delay-400"></div>
        <div className="absolute top-1/4 left-3/4 w-1.5 h-1.5 bg-white rounded-full animate-moveDots delay-600"></div>
        <div className="absolute top-1/2 left-2/3 w-1.5 h-1.5 bg-white rounded-full animate-moveDots delay-800"></div>
      </div>
